...
import cn.renrg.frame.adapter.BannerAdapter;
...
public class BannerView extends FrameLayout {
    ...
    private void initLinearPosition() {
        ...
        mLinearPosition.setPadding(getResources().getDimensionPixelSize(R.dimen.point_margin), 0, 0, 0);
        ...
        if (viewList != null && viewList.size() != 0) {
            if (mLinearPosition.getChildCount() != viewSize) {
                ...
                for (int i = 0; i < diffCnt; i++) {
                    if (needAdd) {
                        ...
                        layoutParams.rightMargin = getResources().getDimensionPixelOffset(R.dimen.point_margin);
                        img.setLayoutParams(layoutParams);
                        img.setBackgroundResource(R.drawable.point_normal);
            ...
            for (int i = 0; i < mLinearPosition.getChildCount(); i++) {
                if (i == (curPos % viewSize)) {
                    mLinearPosition.getChildAt(i).setBackgroundResource(R.drawable.point_selected);
                } else {
                    mLinearPosition.getChildAt(i).setBackgroundResource(R.drawable.point_normal);
                }
            }
        }
    }
